...
public class Items {
    ...
    public static final RegistryObject<Item> PUMPKIN_SPICE_BEEF = ITEMS.register("pumpkin_spice_beef", () -> new Item(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(4).saturation(0.4F).meat().build())));
    public static final RegistryObject<Item> PUMPKIN_SPICE_COOKED_BEEF = ITEMS.register("pumpkin_spice_cooked_beef", () -> new Item(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(10).saturation(0.9F).meat().build())));
    public static final RegistryObject<Item> PUMPKIN_SPICE_CHICKEN = ITEMS.register("pumpkin_spice_chicken", () -> new Item(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(4).saturation(0.3F).effect(new EffectInstance(Effects.HUNGER, 600, 0), 0.3F).meat().build())));
    public static final RegistryObject<Item> PUMPKIN_SPICE_COOKED_CHICKEN = ITEMS.register("pumpkin_spice_cooked_chicken", () -> new Item(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(7).saturation(0.7F).meat().build())));
    public static final RegistryObject<Item> PUMPKIN_SPICE_PORKCHOP = ITEMS.register("pumpkin_spice_porkchop", () -> new Item(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(4).saturation(0.4F).meat().build())));
    public static final RegistryObject<Item> PUMPKIN_SPICE_COOKED_PORKCHOP = ITEMS.register("pumpkin_spice_cooked_porkchop", () -> new Item(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(10).saturation(0.9F).meat().build())));
    public static final RegistryObject<Item> PUMPKIN_SPICE_MUTTON = ITEMS.register("pumpkin_spice_mutton", () -> new Item(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(3).saturation(0.4F).meat().build())));
    ...
    public static final RegistryObject<Item> PUMPKIN_SPICE_LATTE = ITEMS.register("pumpkin_spice_latte", () -> new LatteItem(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(16).food(new Food.Builder().hunger(6).saturation(0.5F).build())));
